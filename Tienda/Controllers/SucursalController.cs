...
namespace Tienda.Controllers
{
    public class SucursalController : Controller
    {
        ...
        public SucursalController(masterContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,Telefono,Status")] Sucursal sucursal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Telefono,Status")] Sucursal sucursal)
        {
            if (id != sucursal.Id)
            {
                return NotFound();
